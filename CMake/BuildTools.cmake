...
function(lorex_target_source EXECUTABLE_NAME SOURCE_DIRS)
    if(SOURCE_DIRS)
        foreach(source_dir IN ITEMS ${SOURCE_DIRS})
            ...
            foreach(file_extension IN LISTS SOURCE_FILE_EXTENSION_LIST INCLUDE_FILE_EXTENSION_LIST)
            ...
            if(src_files_number GREATER 0)
                message(STATUS "[${EXECUTABLE_NAME}] Source dir '${source_dir}' added (${src_files_number})")
            else()
                message(STATUS "[${EXECUTABLE_NAME}] Skip directory ${source_dir} source files not found")
            endif()
